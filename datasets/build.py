...
from .bases_video import VideoDataset, VideoTextDataset, TextDataset
from .cuhkpedes import CUHKPEDES
from .icfgpedes import ICFGPEDES
from .rstpreid import RSTPReid
from .msvd import MSVD
'''
__factory = {'CUHK-PEDES': CUHKPEDES, 'ICFG-PEDES': ICFGPEDES, 'RSTPReid': RSTPReid, 'MSVD': MSVD}
...
def build_dataloader(args, tranforms=None):
    ...
    if args.training:
        ...
        val_img_set = VideoDataset(ds['video_pids'], ds['video_paths'],
                                   val_transforms)
        ...
        ds = dataset.test
        test_img_set = VideoDataset(ds['video_pids'], ds['video_paths'],
                                    test_transforms)
